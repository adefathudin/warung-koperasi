                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="<?php echo base_url('auth/cek_login')?>">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user" id="email" aria-describedby="emailHelp" placeholder="Masukan alamat email..." required autofocus>
                    </div>
                    <div class="form-group">
